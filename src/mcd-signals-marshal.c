...
/* VOID:UINT,UINT,UINT,STRING (mcd-signals-marshal.list:1) */
void
_mcd_marshal_VOID__UINT_UINT_UINT_STRING (GClosure     *closure,
...
/* VOID:UINT,STRING,UINT (mcd-signals-marshal.list:2) */
void
_mcd_marshal_VOID__UINT_STRING_UINT (GClosure     *closure,
                                     GValue       *return_value G_GNUC_UNUSED,
                                     guint         n_param_values,
                                     const GValue *param_values,
                                     gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:STRING,UINT (mcd-signals-marshal.list:3) */
void
_mcd_marshal_VOID__STRING_UINT (GClosure     *closure,
                                GValue       *return_value G_GNUC_UNUSED,
                                guint         n_param_values,
                                const GValue *param_values,
                                gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:UINT,STRING (mcd-signals-marshal.list:4) */
void
_mcd_marshal_VOID__UINT_STRING (GClosure     *closure,
                                GValue       *return_value G_GNUC_UNUSED,
                                guint         n_param_values,
                                const GValue *param_values,
                                gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:UINT,UINT (mcd-signals-marshal.list:5) */
void
_mcd_marshal_VOID__UINT_UINT (GClosure     *closure,
                              GValue       *return_value G_GNUC_UNUSED,
                              guint         n_param_values,
                              const GValue *param_values,
                              gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:OBJECT,ENUM,STRING (mcd-signals-marshal.list:6) */
void
_mcd_marshal_VOID__OBJECT_ENUM_STRING (GClosure     *closure,
                                       GValue       *return_value G_GNUC_UNUSED,
                                       guint         n_param_values,
                                       const GValue *param_values,
                                       gpointer      invocation_hint G_GNUC_UNUSED,
                                       gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__OBJECT_ENUM_STRING) (gpointer     data1,
                                                         gpointer     arg_1,
                                                         gint         arg_2,
                                                         gpointer     arg_3,
                                                         gpointer     data2);
  register GMarshalFunc_VOID__OBJECT_ENUM_STRING callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__OBJECT_ENUM_STRING) (marshal_data ? marshal_data : cc->callback);
...
/* VOID:ENUM,STRING (mcd-signals-marshal.list:7) */
void
_mcd_marshal_VOID__ENUM_STRING (GClosure     *closure,
                                GValue       *return_value G_GNUC_UNUSED,
                                guint         n_param_values,
                                const GValue *param_values,
                                gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:OBJECT,ENUM,ENUM (mcd-signals-marshal.list:8) */
void
_mcd_marshal_VOID__OBJECT_ENUM_ENUM (GClosure     *closure,
                                     GValue       *return_value G_GNUC_UNUSED,
                                     guint         n_param_values,
                                     const GValue *param_values,
                                     gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:INT,STRING (mcd-signals-marshal.list:9) */
void
_mcd_marshal_VOID__INT_STRING (GClosure     *closure,
                               GValue       *return_value G_GNUC_UNUSED,
                               guint         n_param_values,
                               const GValue *param_values,
                               gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:OBJECT,INT,STRING (mcd-signals-marshal.list:10) */
void
_mcd_marshal_VOID__OBJECT_INT_STRING (GClosure     *closure,
                                      GValue       *return_value G_GNUC_UNUSED,
                                      guint         n_param_values,
                                      const GValue *param_values,
                                      gpointer      invocation_hint G_GNUC_UNUSED,
                                      gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__OBJECT_INT_STRING) (gpointer     data1,
                                                        gpointer     arg_1,
                                                        gint         arg_2,
                                                        gpointer     arg_3,
                                                        gpointer     data2);
  register GMarshalFunc_VOID__OBJECT_INT_STRING callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__OBJECT_INT_STRING) (marshal_data ? marshal_data : cc->callback);
...
/* VOID:OBJECT,INT,INT (mcd-signals-marshal.list:11) */
void
_mcd_marshal_VOID__OBJECT_INT_INT (GClosure     *closure,
                                   GValue       *return_value G_GNUC_UNUSED,
                                   guint         n_param_values,
                                   const GValue *param_values,
                                   gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:OBJECT,POINTER (mcd-signals-marshal.list:12) */
void
_mcd_marshal_VOID__OBJECT_POINTER (GClosure     *closure,
                                   GValue       *return_value G_GNUC_UNUSED,
                                   guint         n_param_values,
                                   const GValue *param_values,
                                   gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:UINT,BOOLEAN (mcd-signals-marshal.list:13) */
void
_mcd_marshal_VOID__UINT_BOOLEAN (GClosure     *closure,
                                 GValue       *return_value G_GNUC_UNUSED,
                                 guint         n_param_values,
                                 const GValue *param_values,
                                 gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:UINT,STRING,STRING (mcd-signals-marshal.list:14) */
void
_mcd_marshal_VOID__UINT_STRING_STRING (GClosure     *closure,
                                       GValue       *return_value G_GNUC_UNUSED,
                                       guint         n_param_values,
                                       const GValue *param_values,
                                       gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:BOXED,STRING (mcd-signals-marshal.list:15) */
void
_mcd_marshal_VOID__BOXED_STRING (GClosure     *closure,
                                 GValue       *return_value G_GNUC_UNUSED,
                                 guint         n_param_values,
                                 const GValue *param_values,
                                 gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:POINTER,UINT (mcd-signals-marshal.list:16) */
void
_mcd_marshal_VOID__POINTER_UINT (GClosure     *closure,
                                 GValue       *return_value G_GNUC_UNUSED,
                                 guint         n_param_values,
                                 const GValue *param_values,
                                 gpointer      invocation_hint G_GNUC_UNUSED,
...
/* VOID:UINT,BOXED (mcd-signals-marshal.list:17) */
void
_mcd_marshal_VOID__UINT_BOXED (GClosure     *closure,
                               GValue       *return_value G_GNUC_UNUSED,
                               guint         n_param_values,
                               const GValue *param_values,
                               gpointer      invocation_hint G_GNUC_UNUSED,
